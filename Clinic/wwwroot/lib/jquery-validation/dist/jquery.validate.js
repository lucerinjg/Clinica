...
$.extend( $.validator, {
	...
	messages: {
		...
		digits: "Por favor, solo dígitos.",
		equalTo: "Por favor, ingrese el mismo valor.",
		maxlength: $.validator.format( "Por favor, ingresa como máximo {0} caracteres." ),
		minlength: $.validator.format( "Por favor, ingresa como mínimo {0} caracteres." ),
